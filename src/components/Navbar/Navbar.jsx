    ...
    <header className="navbar">
      ...
      <div className="state-active-parent">
        <div className="state-active">
          ...
          <div className="home">
            <button className="home" onClick={() => irASeccion("home")}>
              Home
            </button>
          </div>
        ...
        <div className="about-us">
          <button className="about-us" onClick={() => irASeccion("about")}>
            Acerca de M
          </button>
        </div>
      </div>
      <div className="instagramtwitterfacebook">
        <div className="services">
          <button className="services" onClick={() => irASeccion("servicio")}>
            Servicios
          </button>
        </div>
      </div>
      <div className="instagramtwitterfacebook1">
        <div className="success-story">
          ...
          <button
            className="services"
            onClick={() => irASeccion("trabajo-exitoso")}
          >
            Trabajos Exitosos
          </button>
        </div>
      ...
      <div className="instagramtwitterfacebook2">
        <div className="testimonial">
          {" "}
          <button className="services" onClick={() => irASeccion("opiniones")}>
            Opiniones
          </button>
        </div>
      </div>
      <div className="instagramtwitterfacebook3">
        <div className="our-team">
          ...
          <button
            className="services"
            onClick={() => irASeccion("nuestro-equipo")}
          >
            Nuestro equipo
          </button>
        </div>
      ...
      <div className="text-block">
        <div className="contact">
          {" "}
          <button
            className="smallnormaljustifyactive"
            style={{ color: "white" }}
